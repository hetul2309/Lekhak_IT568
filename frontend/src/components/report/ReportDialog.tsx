...
const ReportDialog = ({ open, onOpenChange, postTitle, postId }: Props) => {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent
        ...
        className="glass rounded-2xl w-[calc(100vw-2rem)] max-w-lg max-h-[85vh] sm:max-h-[80vh] p-0 gap-0 overflow-hidden !flex !flex-col"
      >
        {/* Header */}
          ...
          <div className="px-6 py-5 space-y-6">
            ...
            <div className="space-y-3 px-1">
              ...
              <Textarea
                ...
                className="h-20 max-h-20 resize-none rounded-xl overflow-y-auto"
                maxLength={500}
        ...
        <div className="border-t border-border/60 px-6 py-4 bg-background/40 shrink-0">
          <Button
            ...
            disabled={isSubmitting}
            className="w-full rounded-full bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-glow-destructive"
          >
            {isSubmitting ? (
              <>
